...
// Per-cleaner pay mode (flexible contractor umbrella, migration 114). The org's
...
export interface Organization {
  ...
  // Request-mode auto-approve threshold (migration 114): the org must keep at
...
export interface Payout {
  ...
  payout_model_snapshot: PayoutModel | null; // which pay mode produced `amount` (migration 114)
  notes: string | null;
...
// PAY REQUESTS (migration 114) — one negotiation thread per appointment for
