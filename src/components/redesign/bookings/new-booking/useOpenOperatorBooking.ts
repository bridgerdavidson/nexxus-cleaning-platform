 ...
 * on the current path. Shallow in-place URL update (no scroll); reads no search params
 * itself, so callers need no Suspense boundary (mirrors the homeowner useOpenBooking).
 *
