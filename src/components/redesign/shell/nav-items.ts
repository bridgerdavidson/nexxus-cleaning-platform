...
export const OPERATOR_NAV: NavItem[] = [
  { id: "overview", label: "Overview", href: "/admin", icon: Home, primary: true },
  { id: "bookings", label: "Bookings", href: "/admin/bookings", icon: ClipboardList, primary: true, requires: "can_view_bookings" },
  { id: "calendar", label: "Calendar", href: "/admin/calendar", icon: CalendarRange, requires: "can_view_bookings" },
  { id: "properties", label: "Properties", href: "/admin/properties", icon: MapPinHouse, requires: "can_view_properties" },
  { id: "people", label: "Customers", href: "/admin/customers", icon: BookUser, primary: true, requires: "can_view_customers" },
  { id: "cleaners", label: "Cleaners & team", href: "/admin/cleaners", icon: Users, requires: "can_manage_cleaners" },
  { id: "services", label: "Services", href: "/admin/services", icon: Tag, requires: "can_view_services" },
