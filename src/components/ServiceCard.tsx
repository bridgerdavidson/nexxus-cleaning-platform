...
export default function ServiceCard({
  ...
  return (
    <div
      ...
      className={`flex flex-col h-full bg-white rounded-xl border shadow-sm transition-all duration-200 ${
        service.is_active
    ...
    >
      <div className="p-6 flex flex-col h-full min-h-0">
        {/* Header + Description: flex-1 so stats sit at bottom */}
        ...
        {/* Stats - bottom justified (pt-4 matches mb-4 above for equal spacing) */}
