 ...
 * a card promotes it to the org default and immediately re-places the manual-capture hold, surfacing
 * the result inline instead of waiting on the JIT cron.
 */
    ...
    <div className="space-y-2">
      ...
      {placing && (
        <p className="flex items-center gap-2 text-sm text-gray-500">
          <Loader2 className="h-4 w-4 animate-spin" /> Placing the card hold...
        </p>
      )}
      {!placing && result && (
        <p
