export const keys = {
  ...
  paymentMethods: {
    ...
    byAppointmentHomeowner: (orgId: string, homeownerId: string) =>
      ['payment-methods', 'appointment-homeowner', orgId, homeownerId] as const,
  },
  conversations: {
  ...
  platform: {
    ...
    alerts: (params: { status?: string | null; limit?: number } = {}) =>
      ['platform', 'alerts', params.status ?? 'open', params.limit ?? 50] as const,
  },
  onboarding: {
