...
export type NotificationEventType =
  ...
  | 'charge_succeeded'              // recipient: homeowner (completion charge landed; their receipt — T2-1)
  | 'cancellation_fee_failed'       // recipient: admins (cancel fee uncollectable or declined)
  | 'cancellation_fee_charged'      // recipient: homeowner (cancel/no-show fee hit their card off-session — T2-1)
  ...
  | 'refund_issued'                 // recipient: homeowner (a refund was created; money on its way back — T2-1)
