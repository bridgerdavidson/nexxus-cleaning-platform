    ...
    try {
      ...
      if (result.error) {
        ...
        if (signInResult.error) {
          ...
          // Both signup and signin succeeded, redirect to profile completion
          setSuccess(true);
          setTimeout(() => {
            router.push('/signup/cleaner/profile');
          }, 1000);
        }
      }
    } catch (err) {
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <div className="text-center">
              ...
              <p className="mt-2 text-center text-sm text-gray-600">
                Your cleaner account has been created. Let's complete your profile!
              </p>
              <div className="mt-6">
                <Link
                  href="/signup/cleaner/profile"
