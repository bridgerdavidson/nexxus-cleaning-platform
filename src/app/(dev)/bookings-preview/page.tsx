...
const ROWS: BookingRowVM[] = [
  {
    ...
    cleaner: "Marco Diaz", cleanerAvatarUrl: null, status: "confirmed", statusLabel: "Confirmed",
    attention: null, payment: { tone: "paid", label: "Paid" }, isUnassigned: false, isSelfPay: false,
  },
  {
    ...
    cleaner: null, cleanerAvatarUrl: null, status: "pending", statusLabel: "Pending",
    attention: null, payment: { tone: "none", label: "Unpaid" }, isUnassigned: true, isSelfPay: false,
  },
  {
    ...
    cleaner: "Sara Kim", cleanerAvatarUrl: null, status: "in_progress", statusLabel: "In progress",
    attention: null, payment: { tone: "paid", label: "Paid" }, isUnassigned: false, isSelfPay: false,
  },
  {
    ...
    cleaner: "Priya Rao", cleanerAvatarUrl: null, status: "confirmed", statusLabel: "Confirmed",
    attention: null, payment: { tone: "selfpay", label: "Self-pay" }, isUnassigned: false, isSelfPay: true,
  },
  {
    ...
    cleaner: "Marco Diaz", cleanerAvatarUrl: null, status: "pending", statusLabel: "Pending",
    attention: "Counter-proposed", payment: { tone: "pending", label: "Pending" }, isUnassigned: false, isSelfPay: false,
  },
  {
    ...
    cleaner: "Sara Kim", cleanerAvatarUrl: null, status: "completed", statusLabel: "Completed",
    attention: null, payment: { tone: "paid", label: "Paid" }, isUnassigned: false, isSelfPay: false,
  },
  {
    ...
    cleaner: "Priya Rao", cleanerAvatarUrl: null, status: "cancelled", statusLabel: "Cancelled",
    attention: null, payment: { tone: "refunded", label: "Refunded" }, isUnassigned: false, isSelfPay: false,
  },
];
...
const DETAIL: BookingDetailVM = {
  ...
  status: "pending", statusLabel: "Pending", attention: "Counter-proposed",
