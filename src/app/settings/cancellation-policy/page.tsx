  ...
  return (
    <>
      <SettingsPageHeader
        ...
        description="When a homeowner cancels late or no-shows, this fee is charged to their card on file. Cleaner-caused or on-time cancellations are always free."
      />
